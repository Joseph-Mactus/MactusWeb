...
export default function Footer() {
  return (
    <footer className="w-full bg-[#262626] border-t border-white/5">
      <div className="bg-[#262626] pt-16 pb-12 px-8">
        ...
        <div className="max-w-7xl mx-auto mt-5 pt-5 mb-0 border-t border-white/5 flex flex-col items-center justify-center gap-6">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#e0006e] transition-all duration-300 shadow-lg">
