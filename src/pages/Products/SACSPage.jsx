...
const SACSPage = () => {
  ...
  desc: "Secure user authentication using fingerprint, access card, and facial recognition technologies.",
  icon: "M12 11c0-1.657-1.343-3-3-3S6 9.343 6 11m12 0c0-1.657-1.343-3-3-3s-3 1.343-3 3m-6 0v2m6-2v2m-9 8h12a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2z"
},
{
  title: "Area Occupancy Control",
  desc: "Restricts the maximum number of qualified users permitted inside a controlled area.",
  icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
},
{
  title: "Duration Tracking with Voice Alerts",
  desc: "Tracks the time users spend inside controlled areas and provides automatic voice alerts when required.",
  icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0zm-3-9h6m-3 0v3"
},
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-start relative z-10 w-full">
          <div className="space-y-6 animate-fade-in-left">
            ...
            <h1 className="text-white font-black leading-[1.05] tracking-tighter flex flex-wrap gap-x-[0.3em]" style={{ fontSize: 'clamp(28px, 4.5vw, 60px)' }}>
              ...
              <span className="overflow-hidden inline-block py-1">
                <span className="animate-reveal-up inline-block pr-1" style={{ animationDelay: '0.5s' }}>everything.</span>
              </span>
            </h1>
          ...
          <div className="relative animate-fade-in-right animate-float">
            ...
            <div className="w-full mt-4 relative rounded-2xl overflow-hidden border border-white/10 bg-[#161622]/90 shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
              ...
              <div className="relative grid grid-cols-3 gap-2 px-2 py-2">
                {[
                  { value: "85+", label: "Units Deployed", icon: (
